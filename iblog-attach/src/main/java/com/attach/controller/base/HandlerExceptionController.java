package com.attach.controller.base;

import com.common.entity.vo.BaseResponse;
import com.common.exception.IBlogException;
...
public class HandlerExceptionController {
    @ExceptionHandler(IBlogException.class)
    public BaseResponse handlerBlogException(IBlogException e) {
